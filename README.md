...
This is a demonstration project showcasing multi-agent AI architecture for pharmaceutical research. The mock data and simplified agents provide a foundation for building production-ready drug discovery tools.
